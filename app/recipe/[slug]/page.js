    ...
    <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card className="p-6 bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <div className="space-y-3">
            <div className="text-gray-600">
              <span className="font-medium">Author:</span> {recipe.author || "Unknown"}
            </div>
            {recipe.source && (
              <div>
                <Link href={recipe.source} className="inline-flex items-center space-x-1 text-orange-600 hover:text-orange-700 transition-colors duration-200">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section>
        <Card className="p-8 bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <div className="prose prose-gray max-w-none">
            <PortableText value={recipe.ingredients} components={portableTextComponents} />
          </div>
        </Card>
      </section>
      ...
      <section>
        <Card className="p-8 bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <div className="prose prose-gray max-w-none">
            <PortableText value={recipe.cookingInstructions} components={portableTextComponents} />
          </div>
        </Card>
      </section>

      <div className="flex justify-center pt-8">
        <Button asChild className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-semibold px-8 py-3 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105">
